# Recompressed builds of MPC-HC

This repository contains a GitHub Actions workflow that fetches the latest upstream release of **MPC-HC**, unpacks it, and recompresses it into a 7z archive with maximum compression.

## Where to get the files

The recompressed builds are published under the [**GitHub Releases**](https://github.com/ddrezip/mpc-hc/releases) page of this repository.
...
Original releases are published by the upstream project: [MPC-HC upstream releases](https://github.com/clsid2/mpc-hc/releases)  
